...
export class BackgroundService {
  ...
  private static ROUTE_ALERT_CORRIDOR_METERS = 55;
  private static FREE_DRIVE_CORRIDOR_METERS = 120;
    ...
    try {
      ...
      for (const radar of nearbyRadars) {
        ...
        const relevance = RadarService.evaluateRouteRelevance({
          ...
          maxCorridorMeters: routeMode
            ? this.ROUTE_ALERT_CORRIDOR_METERS
            : this.FREE_DRIVE_CORRIDOR_METERS * 2,
        ...
        const headingMatched =
          relevance.headingDeltaDeg == null ||
          relevance.headingDeltaDeg <= (routeMode ? 55 : 75);
        ...
        const freeDriveProximityGuard =
          ...
          relevance.corridorDistanceMeters <= this.FREE_DRIVE_CORRIDOR_METERS;
        ...
        if (shouldAlert) {
          ...
          const corridorScore =
            relevance.corridorDistanceMeters == null
              ...
              : 1 -
                Math.min(
                  relevance.corridorDistanceMeters /
                    (routeMode
                      ? this.ROUTE_ALERT_CORRIDOR_METERS
                      : this.FREE_DRIVE_CORRIDOR_METERS * 2),
                  1
