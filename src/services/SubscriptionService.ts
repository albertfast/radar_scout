...
const ANDROID_SUBSCRIPTION_MANAGEMENT_URL =
  'https://play.google.com/store/account/subscriptions?package=com.radarscout.app';
...
export class SubscriptionService {
  ...
  private static markInvalidCredentials(error: unknown, context: string): void {
    ...
    const message = `[RevenueCat] invalid credentials (${context}). Verify ${platformKeyName} and RevenueCat app mapping for package com.radarscout.app.`;
  ...
  static async openSubscriptionManagement(): Promise<void> {
    const url = this.getSubscriptionManagementUrl();
