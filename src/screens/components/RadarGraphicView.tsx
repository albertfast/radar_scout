...
import { LineChart, StatCard } from '../../components/AnimatedCharts';
      ...
      >
        ...
        >
          <View style={styles.sectionHeader}>
            <MaterialCommunityIcons name="radar" size={20} color="#4ECDC4" />
            <Text style={styles.sectionTitle}>Weekly Radar Field</Text>
          </View>
          <GraphicRadarPanelView
            signalLevel={radarSignalLevel}
            dangerLevel={radarDangerLevel}
            style={styles.graphicRadarPanel}
          />
        </LinearGradient>
      </Animated.View>
