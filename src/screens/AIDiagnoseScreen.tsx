      ...
      >
        ...
        <Surface style={styles.infoBox} elevation={1}>
          ...
          <Text style={styles.infoText}>
            Bu özellik araba arıza ışıkları hakkında bilgi verir. Model cihazınızda yüklü olduğu için internetsiz ortamda da çalışabilir. Not: Yapay zekanın hata yapma ihtimali olduğunu lütfen unutmayın.
          </Text>
        </Surface>
