...
import ThreeBackgroundNative from '../../../components/ThreeBackgroundNative';
...
export function RadarHomeDashboard({
  ...
  return (
    <View style={styles.container}>
      <ThreeBackgroundNative theme="dark" />
      ...
      <View style={[styles.mainHeader, { paddingTop: insetsTop + 10 }]}> 
        ...
        <Text style={styles.appName}>
          RADAR <Text style={{ color: '#FF5252' }}>SCOUT</Text>
        </Text>
      ...
      >
        ...
        <View style={[styles.heroCard, { marginTop: heroTopMargin, paddingVertical: heroVerticalPadding }]}>
          <LinearGradient
            colors={['rgba(11, 18, 36, 0.4)', 'rgba(8, 16, 31, 0.6)']}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 1 }}
