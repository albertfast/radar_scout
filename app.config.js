...
module.exports = {
  expo: {
    ...
    slug: "radar-scout",
    version: APP_VERSION,
    icon: "./assets/radar-scout-icon.png",
    ...
    android: {
      ...
      adaptiveIcon: {
        foregroundImage: "./assets/radar-scout-adaptive-icon.png",
    ...
    web: {
      ...
      scope: "./",
      themeColor: "#FF6B35",
      favicon: "./assets/radar-scout-favicon.png"
    },
    plugins: [
      "expo-asset",
      "expo-font",
      ...
      "./plugins/withXcodeProjectCompat.js",
